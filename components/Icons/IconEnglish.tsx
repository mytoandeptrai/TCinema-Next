interface IconEnglishProps extends React.SVGProps<SVGSVGElement> {}

const IconEnglish = ({ width, height, ...props }: IconEnglishProps) => {
  return (
    <svg
    ...
    >
      ...
      <g>
        <polygon fill="#D32030" points="170.511,306.056 169.8,306.771 170.511,306.771  " />
        <polygon fill="#D32030" points="190.084,286.487 190.794,286.487 190.794,285.773  " />
        <polygon fill="#D32030" points="281.229,196.737 280.545,196.737 280.545,197.425  " />
        <polygon fill="#D32030" points="171.21,176.457 170.511,175.754 170.511,176.457  " />
        <polygon fill="#D32030" points="190.794,196.037 190.794,196.737 191.494,196.737  " />
      </g>
      <g>
        <path
          fill="#252F6C"
