...
const ButtonScrollToTop = () => {
  const [isShowedBtn, setIsShowedBtn] = useState(false);
  ...
  const goToTopHandler = useCallback(() => {
    window.scrollTo({
      top: 0,
      behavior: 'smooth'
    });
  ...
  if (!isShowedBtn) return null;

  return (
    <div className={cx('buttonWrapper')} onClick={goToTopHandler}>
      <svg
